 ...
 * @author JesusMini
 */
public class RegistrarDevolucionFacturas extends javax.swing.JFrame {

    /**
     * Creates new form DefinirProductos
     */
    public RegistrarDevolucionFacturas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Devolucion de Factura");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarDevolucionFacturas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarDevolucionFacturas().setVisible(true);
            }
        });
    }
