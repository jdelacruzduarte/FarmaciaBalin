...
public class BuscarUsuario extends javax.swing.JFrame {
    ...
    void cargar(String valor) {
        try{
            String [] titulos={"Codigo", "Nombre","Apellido","Cedula","Telefono","Celular","Sexo","Direccion","Estado"};
            ...
            while(rs.next()){
                ...
                registros[2]=rs.getString("ApellidoUsuario");
                registros[3]=rs.getString("CedulaUsuario");
                registros[4]=rs.getString("TelefonoUsuario");
                registros[5]=rs.getString("CelularUsuario");
                registros[6]=rs.getString("SexoUsuario");
                registros[7]=rs.getString("DireccionUsuario");
                registros[8]=rs.getString("EstadoUsuario");
                ...
                tableProveedores.getColumnModel().getColumn(6).setPreferredWidth(150);
    ...
    private void jTree1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTree1MouseClicked
       ...
       if (menu.equals("Definir Productos")){
        ...
        if (menu.equals("Registrar Devolucion de Factura")){
            BuscarUsuario RegDevFac = new BuscarUsuario();
